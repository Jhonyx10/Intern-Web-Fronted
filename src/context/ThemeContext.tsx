...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const hoverColor = settings?.theme_color_hover || matchedPreset?.hover || activeColor
        const softColor = settings?.theme_color_soft || matchedPreset?.soft || `${activeColor}1e`
